...
class craft_translate extends CModule
{
	const MODULE_ID = 'craft.translate';
	const DIR_MODULE = 'local';

	var $MODULE_ID = "craft.translate";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME = '[craft] Переводы';
	var $MODULE_DESCRIPTION = 'Дополнение к решению мультиязычности сайта';
	var $MODULE_CSS;
	...
	function InstallDB()
	{
		...
		if(!$DB->TableExists('craft_translate'))
		{
