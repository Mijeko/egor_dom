...
<template>
  <div class="modern-input">
    <!-- Ваша собственная HTML структура -->
    ...
    <!-- 
      Выше пример базовой структуры. Вы можете полностью переделать HTML под свои нужды.
      Доступные переменные:
      - modelValueComp - для v-model (используйте v-model="modelValueComp")
      - hasError - boolean, есть ли ошибки
      - errorMessages - массив всех сообщений об ошибках
      - firstError - первое сообщение об ошибке (строка)
      - validateValue(value) - функция для валидации значения
    -->
  </div>
</template>
